                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              AvatarWidget(radius: 30, address: widget.data.to),
                              addWidth(SpacingSize.xs),
                              Text(
                                showEllipse(widget.data.to),
                                style: const TextStyle(fontSize: 12),
                              ),
                            ],
                          ),
                            ...
                            MaterialPageRoute(
                              builder: (_) => BlockWebView(
                                url:
                                    getWalletProvider(
                                      context,
                                    ).activeNetwork.transactionViewUrl +
                                    widget.data.hash,
                                title: getText(context, key: 'transaction'),
                              ),
                            ),
                          );
                        },
